...
<template>
    <div class="relative">
        ...
        <div class="flex items-center gap-x-2">
            <button class="w-[205px] cursor-pointer border border-white rounded-md p-2 shadow shadow-black font-semibold" :class="step.value ? 'bg-orange-500' : 'bg-yellow-300'" v-text="step.human_type" @mouseover="tooltip.index=index;tooltip.show=true" @mouseout="tooltip.show=false"></button>
